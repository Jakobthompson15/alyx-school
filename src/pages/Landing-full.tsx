              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 max-w-4xl mx-auto">
                {languages.map((item, index) => (
                  <motion.div
                    ...
                    className="text-center p-6 rounded-lg bg-card border border-border/50 shadow-sm"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <Card className="h-full border border-border/50 bg-card hover:shadow-md transition-all duration-300">
